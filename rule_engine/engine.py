            ...
            alerts.append(
                {
                    "timestamp": now,
                    "priority": "info",
                    "message": f"₹{event['amount']} income received. ₹100 save karna chahenge?",
                    "reason": "income_event",
                }
            )
            ...
            alerts.append(
                {
                    "timestamp": now,
                    "priority": "high",
                    "message": "⚠️ Paisa 3 din mein khatam ho sakta hai. Kal thoda kam kharch karein.",
            ...
            alerts.append(
                {
                    "timestamp": now,
                    "priority": "medium",
                    "message": "Aaj spending usual se high hai. ₹120 kam kharch se runway improve hoga.",
                    "reason": "overspending",
                }
            )
